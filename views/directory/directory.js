...
(function(window) {
    ...
    var support = { transitions: Modernizr.csstransitions },
        ...
        // content close ctrl
        contentCloseCtrl = contentEl.querySelector("button.content__button.exit"),
    ...
    function initEvents() {
        ...
        pins.forEach(function(pin) {
            if (pin.getAttribute("data-ref")) {
                var contentItem = contentEl.querySelector(
                    '.content__item[data-space="' + pin.getAttribute("data-ref") + '"]'
                );
            } else {
                var contentItem = contentEl.querySelector(
            ...
            pin.addEventListener("click", function(ev) {
                ...
                if (pin.getAttribute("data-ref")) {
                    openContent(
                        pin.getAttribute("data-space"),
                        pin.getAttribute("data-ref")
                    );
                } else {
                    openContent(pin.getAttribute("data-space"), null);
                }
    ...
    function showPins(levelEl) {
        ...
        if (levelEl.querySelector(".level__pins") !== null) {
     ...
     */
    function openContent(spacerefval, pinrefval) {
    ...
    function showSpace(sliding) {
        ...
        if (pinref !== null) {
            var contentItem = contentEl.querySelector(
                '.content__item[data-space="' + pinref + '"]'
            );
        } else {
            var contentItem = contentEl.querySelector(
